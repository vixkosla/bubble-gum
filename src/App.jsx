...
const spheres = [
  ...
  { position: [1.5, -0.5, 1], size: 0.7, color: '#8A8A8A', dCoef: { a: 0.1, b: 0.2 }, clearcoat: 0.8, roughness: 0.4, metalness: 1 },
  { position: [-1.15, -1.5, -1], size: 0.9, color: '#363636', dCoef: { a: 0.1, b: 0.2 }, roughness: 0.1, metalness: 1 },
  { position: [-1.6, 1.6, -0.8], size: 1, color: 'silver', dCoef: { a: 0.1, b: 0.2 }, roughness: 0.4, metalness: 1 },

  { position: [1.2, -0.5, -1.8], size: 1.2, color: '#D9D9D9', dCoef: { a: 0.1, b: 0.2 }, roughness: 0.5, metalness: 0 },
  { position: [1.3, 2.2, -0.95], size: 1.25, color: 'silver', dCoef: { a: 0.2, b: 0.1 }, clearcoat: 1, roughness: 0.6, metalness: 0.8 },
